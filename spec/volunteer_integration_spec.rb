...
describe 'the project creation path', {:type => :feature} do
  it 'takes the user to the homepage where they can create a project' do
    ...
    fill_in('description', :with => 'React.js and more!')
    click_button('Create Project')
    expect(page).to have_content('Teaching Kids to Code')
    expect(page).to have_content('React.js and more!')
  end
end
...
describe 'the project update path', {:type => :feature} do
  it 'allows a user to change the name of the project' do
    test_project = Project.new({:title => 'Teaching Kids to Code', :id => nil, :description => "Teach kids to code at lincoln high school"})
    test_project.save
    visit '/'
